...
interface TextProps {
  ...
  fs?: 12 | 14 | 16 | 18 | 20 | 22 | 24 | 28 | 30 | 32 | 36 | 40;
  lgfs?: 12 | 14 | 16 | 18 | 20 | 22 | 24 | 28 | 30 | 32 | 36 | 40;
  mdfs?: 12 | 14 | 16 | 18 | 20 | 22 | 24 | 28 | 30 | 32 | 36 | 40;
  smfs?: 12 | 14 | 16 | 18 | 20 | 22 | 24 | 28 | 30 | 32 | 36 | 40;
  lh?: 125 | 140;
...
const Text = ({
  ...
  const classes = `text fw-${fw} lgfw-${lgfw} mdfw-${mdfw} smfw-${smfw} fs-${fs} lgfs-${lgfs} mdfs-${mdfs} smfs-${smfs} lh-${lh}${
    color ? " text-" + color : ""
  }${isCenter ? " text-center" : ""}${classNames ? " " + classNames : ""}`;
  switch (tag) {
    case "span": {
